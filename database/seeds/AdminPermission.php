...
class AdminPermission extends Seeder
{
    ...
    public function run(): void
    {
        $this->table('admin_permission')->insert([
            ...
            ['id' => 18, 'admin_role_id' => 2, 'controller' => 'house.contract', 'action' => '*'],
            ['id' => 19, 'admin_role_id' => 2, 'controller' => 'house.other', 'action' => '*'],
            ['id' => 20, 'admin_role_id' => 2, 'controller' => 'we', 'action' => 'index'],
            ['id' => 21, 'admin_role_id' => 2, 'controller' => 'we.meter', 'action' => '*'],
            ['id' => 22, 'admin_role_id' => 2, 'controller' => 'we.water', 'action' => '*'],
            ['id' => 23, 'admin_role_id' => 2, 'controller' => 'we.electricity', 'action' => '*'],
            ['id' => 24, 'admin_role_id' => 2, 'controller' => 'bill', 'action' => 'index'],
            ['id' => 25, 'admin_role_id' => 2, 'controller' => 'bill.annual', 'action' => '*'],
            ['id' => 26, 'admin_role_id' => 2, 'controller' => 'bill.report', 'action' => '*'],
            ['id' => 27, 'admin_role_id' => 2, 'controller' => 'property', 'action' => '*'],
            ['id' => 28, 'admin_role_id' => 2, 'controller' => 'number', 'action' => '*'],
            ['id' => 29, 'admin_role_id' => 2, 'controller' => 'uncollected', 'action' => '*'],
